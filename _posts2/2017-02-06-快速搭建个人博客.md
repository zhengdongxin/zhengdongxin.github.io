...
> 
> [我的的博客](http://zhengdongxin.top)

# 前言
从 Jekyll 到 GitHub Pages 中间踩了许多坑，终于把我的个人博客[BY Blog](http://zhengdongxin.top)搭建出来了。。。

本教程针对的是不懂技术又想搭建个人博客的小白，操作简单暴力且快速。当然懂技术那就更好了。

看看看博客的主页样式：

[![](http://upload-images.jianshu.io/upload_images/2178672-51a2fe6fbe24d1cd.jpg?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)](http://zhengdongxin.github.io/)

在手机上的布局：

[![](http://upload-images.jianshu.io/upload_images/2178672-d58bb45f9faedb70.jpg)](http://zhengdongxin.github.io/)
...
注册完成后搜索 `zhengdongxin.github.io` 进入[我的仓库](https://github.com/zhengdongxin/zhengdongxin.github.io)
...
keyword: "BY, BY Blog, 柏荧的博客, zhengdongxin, 邱柏荧, iOS, Apple, iPhone" #关键词
url: "https://zhengdongxin.github.io"          # 这个就是填写你的博客地址
baseurl: ""      # 这个我们不用填写
...
> 很对人反映 Disqus 评论插件加载不出来，因为 Disqus 在国内加载缓慢，所以我新集成了 Gitalk 评论插件（感谢[@FeDemo](https://github.com/FeDemo)的推荐），喜欢折腾的朋友可以看这篇：[《为博客添加 Gitalk 评论插件》](http://zhengdongxin.top/2017/12/19/%E4%B8%BA%E5%8D%9A%E5%AE%A2%E6%B7%BB%E5%8A%A0-Gitalk-%E8%AF%84%E8%AE%BA%E6%8F%92%E4%BB%B6/)。 我已经在`_config.yml` 配置就好了，只需要填写参数可以了。
...
搭建好博客之后 你可能不想直接使用 [baiyingqiu.github.io](http://baiyingqiu.github.io) 这么长的博客域名吧, 想换成想 [zhengdongxin.top](http://zhengdongxin.top) 这样简短的域名。那我们开始吧！
...
用**阿里云** app也可以注册域名，域名的价格根据后缀的不同和域名的长度而分，比如我这个 `zhengdongxin.top` 的域名第一年才只要4元~
...
一个主机记录为 `www`,代表可以解析 `www.zhengdongxin.top`的域名

另一个为 `@`, 代表 `zhengdongxin.top`
...
若本教程顺利帮你搭建了自己的个人博客，请不要 **害羞**，给我的 [github仓库](https://github.com/zhengdongxin/zhengdongxin.github.io) 点个 **star** 吧！

因为最近发现 Fork 将近破百，加上直接 Clone 仓库的，保守估计已经帮助上百人成功的搭建了自己的博客，~~可是 Star 却仅仅只有 **12**！可能还是做的不够好吧！~~现在已经破百了，感谢大家的Star！

### **别无他求，点个 [Star](https://github.com/zhengdongxin/zhengdongxin.github.io) 吧**！
