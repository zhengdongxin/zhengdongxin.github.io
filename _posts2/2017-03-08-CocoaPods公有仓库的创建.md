...
> 本文发布于 [BY Blog](http://zhengdongxin.github.io)、[简书](http://www.jianshu.com/p/d2d98298b1b8) 转载请保留链接
...
下面我们将一步步把我封装的这个简单的TextFiled控件 [BYPhoneNumTF](https://github.com/zhengdongxin/BYPhoneNumTF) 上传到 Cocoapods 公有仓库中。
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/zhengdongxin/BYPhoneNumTF" # 你的主页
  s.source       = { :git => "https://github.com/zhengdongxin/BYPhoneNumTF.git", :tag => "#{s.version}" }#你的仓库地址，不能用SSH地址
  ...
  # User
  s.author             = { "BY" => "zhengdongxinios@163.com" } # 作者信息
  s.social_media_url   = "http://zhengdongxin.github.io" # 个人主页
...
但是很多情况没这么顺利，比如:
	 ...
	 -> BYPhoneNumTF (1.0.0)
	    - WARN  | url: There was a problem validating the URL http://zhengdongxin.github.io.
...
---
	-> BYPhoneNumTF (1.0.0)
	   ...
	   - Homepage: https://github.com/zhengdongxin/BYPhoneNumTF
	   - Source:   https://github.com/zhengdongxin/BYPhoneNumTF.git
