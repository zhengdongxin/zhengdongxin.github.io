...
当然，你也可以手动创建issue作为 gitalk评论容器。只要有 `Gitalk` 标签 和 `id` 对应标签就可以。比我我自己创建的 [About issue](https://github.com/zhengdongxin/zhengdongxin.github.io/issues/38) 。
...
最后，[给个 star 吧](https://github.com/zhengdongxin/zhengdongxin.github.io)~