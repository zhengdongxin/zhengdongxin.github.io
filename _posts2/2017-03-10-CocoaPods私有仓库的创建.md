...
> 
> 上一篇文章 [《CocoaPods公有仓库的创建》](http://zhengdongxin.top/2017/03/08/CocoaPods公有仓库的创建/)
...
在上一篇[《CocoaPods公有仓库的创建》](http://zhengdongxin.top/2017/03/08/CocoaPods公有仓库的创建/)中我们了解到，`master` 目录中只存放 代码库 的描述文件，而不是存放代码。就像这样
...
通过 [《CocoaPods私有仓库的创建》](http://zhengdongxin.top/2017-03-10-CocoaPods私有仓库的创建/) 和 [《CocoaPods公有仓库的创建](http://zhengdongxin.top/2017/03/08/CocoaPods公有仓库的创建/)》这两篇文章，相信大家对CocoaPods的工作原理都有了更深层次的了解。
